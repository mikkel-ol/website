  ...
  return (
    <div className="text-sm text-slate-500 flex flex-col gap-2">
      <p>
        ...
        <Link href="https://neovim.io">Neovim</Link> and a little <Link href="https://code.visualstudio.com">Visual Studio Code</Link> when
        Vim was being Vim. Built with <Link href="https://react.dev">React</Link> and{" "}
