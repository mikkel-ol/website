    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <section className="col-start-1 lg:sticky top-0 max-h-screen lg:py-24 flex flex-col justify-between">
        <header>
          ...
          <TypeAnimation preRenderFirstString sequence={roles} speed={70} className="text-xl text-slate-200 font-medium mt-3" repeat={0} />

          <p className="mt-6 mb-4 lg:mb-16 max-w-sm">
            <span className="italic">DRY, SOLID, KISS</span> — a combination of acronyms that sounds wrong to most people, but makes perfect
            sense to a software developer with a passion for clean code and robust architecture.
          </p>
